...
THROUGHPUT=one_lock_queue_throughput two_lock_queue_throughput non_blocking_queue_throughput one_lock_blocking_queue_throughput 
CORRECTNESS=one_lock_queue_correctness two_lock_queue_correctness non_blocking_queue_correctness one_lock_blocking_queue_correctness
...
ONE_LOCK_BLOCKING_QUEUE = queues/one_lock_blocking_queue.h
...
one_lock_blocking_queue_throughput : driver_throughput.cpp $(COMMON) $(ONE_LOCK_BLOCKING_QUEUE)
	$(CXX) $(CXXFLAGS) -DONE_LOCK_BLOCKING_QUEUE $< $(LDFLAGS) -o $@
...
one_lock_blocking_queue_correctness : driver_correctness.cpp $(COMMON) $(ONE_LOCK_BLOCKING_QUEUE)
	$(CXX) $(CXXFLAGS) -DONE_LOCK_BLOCKING_QUEUE $< $(LDFLAGS) -o $@
